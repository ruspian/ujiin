...
import { DeleteAgamaModalProps } from "@/types/religion";

export default function DeleteAgamaModal({
  itemData,
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4 backdrop-blur-sm">
      <div className="w-full max-w-md animate-in fade-in zoom-in-95 duration-200 rounded-2xl bg-white p-6 text-center shadow-2xl ring-1 ring-gray-200">
        ...
        <p className="mb-6 text-sm text-gray-500 leading-relaxed">
          Yakin ingin menghapus agama{" "}
          <span className="font-bold text-gray-900">{itemData.name}</span>?{" "}
          <br />
